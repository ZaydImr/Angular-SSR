...
export class AppComponent {
  ...
  tools = [
    { title : 'Angular 16', img : 'https://img.icons8.com/?size=44&id=l9a5tcSnBwcf&format=png'},
    { title : '`SSR` Server side rendering', img : 'https://img.icons8.com/?size=44&id=ht5OgXaoBIO2&format=png'},
    ...
    { title : 'SCSS + TailwindCSS', img : 'https://img.icons8.com/?size=44&id=CIAZz2CYc6Kc&format=png'},
